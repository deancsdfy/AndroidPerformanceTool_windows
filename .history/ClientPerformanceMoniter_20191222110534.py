...
class ClientPerformanceMoniter(object):
    def __init__(self):
        ...
        self.devicesName = info.getDevicesName()
        pass
    ...
    def StartMonitor(self):
        ...
        date = datetime.datetime.now().strftim("%Y--%m--%d %H")
        while 1:
            ...
            workbook.save('./Data/{}_{}.xlsx'.format(date,self.devicesName))
